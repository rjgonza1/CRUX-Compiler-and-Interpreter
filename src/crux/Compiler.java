...
public class Compiler {
    public static String studentName = "Ryan Gonzales";
    public static String studentID = "57555019";
    public static String uciNetID = "rjgonza1";
    
    public static void main(String[] args)
    {
        String sourceFilename = "test07.crx";
