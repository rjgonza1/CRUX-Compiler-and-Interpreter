...
public class Program {
    ...
    public void appendEpilogue(int frameSize)
    {
    	...
    	String localVars = "addu $sp, $sp, " + String.valueOf(frameSize);
    	if(frameSize > 0)
    		epilogue.add(localVars);
    	epilogue.add("lw $ra, 4($sp)");
    	epilogue.add("lw $fp, 0($sp)");
    	epilogue.add("addu $sp, $sp, 8");
    	epilogue.add("jr $ra");
